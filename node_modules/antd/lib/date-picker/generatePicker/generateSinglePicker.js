  ...
  function getPicker(picker, displayName) {
    ...
    const Picker = /*#__PURE__*/(0, React.forwardRef)((props, ref) => {
      const {
        ...
        restProps = __rest(props, ["prefixCls", "getPopupContainer", "style", "className", "rootClassName", "size", "bordered", "placement", "placeholder", "popupClassName", "dropdownClassName", "disabled", "status", "clearIcon"]);
      const {
        getPrefixCls,
        direction,
        getPopupContainer,
      ...
      return wrapSSR( /*#__PURE__*/React.createElement(_rcPicker.default, Object.assign({
        ...
        allowClear: {
          clearIcon: clearIcon !== null && clearIcon !== void 0 ? clearIcon : /*#__PURE__*/React.createElement(_CloseCircleFilled.default, null)
        }
      })));
    });
    if (displayName) {
